...
A tiny macOS command-line tool that stops your Mac from falling asleep. It works kind of like Apple's own `caffeinate`, using a native IOKit power assertion under the hood.
